...
import java.io.IOException;
    ...
    public class found_child extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView ( R.layout.activity_found_child );

            storageReference = FirebaseStorage.getInstance().getReference("Found");
            ...
            progressDialog = new ProgressDialog( com.example.imagelink.found_child .this);// context name as per your project name
...
//finish om create
        ...
        public void UploadImage() {
            ...
            if (FilePathUri != null) {
                ...
                Toast.makeText( com.example.imagelink.found_child .this, "Please Select Image or Add Image Name", Toast.LENGTH_LONG).show();
